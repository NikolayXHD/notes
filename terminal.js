...
var scroll_container = document.querySelector('#space>div>div');
if (scroll_container) {
  style_attr = scroll_container.getAttribute('style');
  modified_val = style_attr.replace('overflow: scroll;', '');
  scroll_container.setAttribute('style', modified_val);
}

var scroll_divs = document.querySelectorAll(`
[class*="packages-core-lib-containers-Space-styles-cut-"]>div>div:nth-last-child(1),
[class*="packages-core-lib-containers-Space-styles-cut-"]>div>div:nth-last-child(1) div,
[class*="packages-core-lib-containers-Space-styles-cut-"]>div>div:nth-last-child(2),
[class*="packages-core-lib-containers-Space-styles-cut-"]>div>div:nth-last-child(2) div
...
[class*="packages-core-lib-containers-Space-styles-cut-"]>div>div:nth-last-child(2) div
`)
for (var d of scroll_divs) {
  style_attr = d.getAttribute('style');
  modified_val = style_attr.replace('display: block;', '');
  d.setAttribute('style', modified_val);
}
